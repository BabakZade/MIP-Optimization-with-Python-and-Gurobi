...
namespace DataLayer
{
    public class ImportData
    {
        ...
        {
            SqlConnection connection = new SqlConnection("Server=  (localdb)\\MSSQLLocalDB;Database=UGentMedicalStudentRostering;Trusted_Connection=True;MultipleActiveResultSets=true");

            SqlCommand cmd = new SqlCommand();
            cmd.CommandType = System.Data.CommandType.Text;
            cmd.CommandText = "INSERT MSRRegionInfo (RegionName, AccomodationCap) VALUES ('NorthWestern',5)";
